...
class LINE:
  ...
  def __init__(self):
    ...
    self._headers = {'X-Line-Application': 'CHROMEOS\t1.4.17\Chrome_OS\t1', 'X-Line-Access': 'EnMtvLdtNo6K4ckNN5sd.UvZQ8iaX1kDhGbAShThZ3q.yrEQOSuqpgs6SwXz7q+IhDwz05E3N3E+HsjuYemmlRM=', 'User-Agent': 'Line/1.4.17'}
